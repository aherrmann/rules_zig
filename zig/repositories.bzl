...
_VAR_CACHE_PREFIX = "RULES_ZIG_CACHE_PREFIX"
_VAR_CACHE_PREFIX_LINUX = "RULES_ZIG_CACHE_PREFIX_LINUX"
_VAR_CACHE_PREFIX_MACOS = "RULES_ZIG_CACHE_PREFIX_MACOS"
_VAR_CACHE_PREFIX_WINDOWS = "RULES_ZIG_CACHE_PREFIX_WINDOWS"

_ENV = [
    _VAR_CACHE_PREFIX,
    _VAR_CACHE_PREFIX_LINUX,
    _VAR_CACHE_PREFIX_MACOS,
    _VAR_CACHE_PREFIX_WINDOWS,
]

_DEFAULT_CACHE_PREFIX = "/tmp/zig-cache"
_DEFAULT_CACHE_PREFIX_LINUX = "/tmp/zig-cache"
_DEFAULT_CACHE_PREFIX_MACOS = "/var/tmp/zig-cache"
_DEFAULT_CACHE_PREFIX_WINDOWS = "C:\\Temp\\zig-cache"

def _env_zig_cache_prefix(environ, platform):
    if platform.find("linux") != -1:
        cache_prefix = environ.get(_VAR_CACHE_PREFIX_LINUX, environ.get(_VAR_CACHE_PREFIX, _DEFAULT_CACHE_PREFIX_LINUX))
    elif platform.find("macos") != -1:
        cache_prefix = environ.get(_VAR_CACHE_PREFIX_MACOS, environ.get(_VAR_CACHE_PREFIX, _DEFAULT_CACHE_PREFIX_MACOS))
    elif platform.find("windows") != -1:
        cache_prefix = environ.get(_VAR_CACHE_PREFIX_WINDOWS, environ.get(_VAR_CACHE_PREFIX, _DEFAULT_CACHE_PREFIX_WINDOWS))
    else:
        cache_prefix = environ.get(_VAR_CACHE_PREFIX, _DEFAULT_CACHE_PREFIX)
...
def _zig_repo_impl(repository_ctx):
    ...
    cache_prefix = _env_zig_cache_prefix(repository_ctx.os.environ, repository_ctx.attr.platform)
