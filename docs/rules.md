...
<pre>
zig_binary(<a href="#zig_binary-name">name</a>, <a href="#zig_binary-deps">deps</a>, <a href="#zig_binary-srcs">srcs</a>, <a href="#zig_binary-data">data</a>, <a href="#zig_binary-copts">copts</a>, <a href="#zig_binary-csrcs">csrcs</a>, <a href="#zig_binary-extra_srcs">extra_srcs</a>, <a href="#zig_binary-linkdeps">linkdeps</a>, <a href="#zig_binary-linker_script">linker_script</a>, <a href="#zig_binary-main">main</a>)
</pre>
...
| <a id="zig_binary-linkdeps"></a>linkdeps |  Libraries to link the target against, typically `cc_library` targets.   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
...
| <a id="zig_library-linkdeps"></a>linkdeps |  Libraries to link the target against, typically `cc_library` targets.   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
...
<pre>
zig_shared_library(<a href="#zig_shared_library-name">name</a>, <a href="#zig_shared_library-deps">deps</a>, <a href="#zig_shared_library-srcs">srcs</a>, <a href="#zig_shared_library-data">data</a>, <a href="#zig_shared_library-copts">copts</a>, <a href="#zig_shared_library-csrcs">csrcs</a>, <a href="#zig_shared_library-extra_srcs">extra_srcs</a>, <a href="#zig_shared_library-linkdeps">linkdeps</a>, <a href="#zig_shared_library-linker_script">linker_script</a>, <a href="#zig_shared_library-main">main</a>)
</pre>
...
| <a id="zig_shared_library-linkdeps"></a>linkdeps |  Libraries to link the target against, typically `cc_library` targets.   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
...
<pre>
zig_test(<a href="#zig_test-name">name</a>, <a href="#zig_test-deps">deps</a>, <a href="#zig_test-srcs">srcs</a>, <a href="#zig_test-data">data</a>, <a href="#zig_test-copts">copts</a>, <a href="#zig_test-csrcs">csrcs</a>, <a href="#zig_test-extra_srcs">extra_srcs</a>, <a href="#zig_test-linkdeps">linkdeps</a>, <a href="#zig_test-linker_script">linker_script</a>, <a href="#zig_test-main">main</a>)
</pre>
...
| <a id="zig_test-linkdeps"></a>linkdeps |  Libraries to link the target against, typically `cc_library` targets.   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
