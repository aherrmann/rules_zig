...
zig_configure(<a href="#zig_configure-name">name</a>, <a href="#zig_configure-actual">actual</a>, <a href="#zig_configure-extra_toolchains">extra_toolchains</a>, <a href="#zig_configure-host_mode">host_mode</a>, <a href="#zig_configure-host_threaded">host_threaded</a>, <a href="#zig_configure-host_use_cc_common_link">host_use_cc_common_link</a>,
              <a href="#zig_configure-host_zigopt">host_zigopt</a>, <a href="#zig_configure-mode">mode</a>, <a href="#zig_configure-target">target</a>, <a href="#zig_configure-threaded">threaded</a>, <a href="#zig_configure-translate_c">translate_c</a>, <a href="#zig_configure-use_cc_common_link">use_cc_common_link</a>, <a href="#zig_configure-zig_version">zig_version</a>,
              <a href="#zig_configure-zigopt">zigopt</a>)
</pre>
...
| <a id="zig_configure-translate_c"></a>translate_c |  If true, enables the external translate-c toolchain when one is registered.   | Integer | optional |  `-1`  |
...
zig_configure_binary(<a href="#zig_configure_binary-name">name</a>, <a href="#zig_configure_binary-actual">actual</a>, <a href="#zig_configure_binary-extra_toolchains">extra_toolchains</a>, <a href="#zig_configure_binary-host_mode">host_mode</a>, <a href="#zig_configure_binary-host_threaded">host_threaded</a>,
                     <a href="#zig_configure_binary-host_use_cc_common_link">host_use_cc_common_link</a>, <a href="#zig_configure_binary-host_zigopt">host_zigopt</a>, <a href="#zig_configure_binary-mode">mode</a>, <a href="#zig_configure_binary-target">target</a>, <a href="#zig_configure_binary-threaded">threaded</a>, <a href="#zig_configure_binary-translate_c">translate_c</a>,
                     <a href="#zig_configure_binary-use_cc_common_link">use_cc_common_link</a>, <a href="#zig_configure_binary-zig_version">zig_version</a>, <a href="#zig_configure_binary-zigopt">zigopt</a>)
</pre>
...
| <a id="zig_configure_binary-translate_c"></a>translate_c |  If true, enables the external translate-c toolchain when one is registered.   | Integer | optional |  `-1`  |
...
zig_configure_test(<a href="#zig_configure_test-name">name</a>, <a href="#zig_configure_test-actual">actual</a>, <a href="#zig_configure_test-extra_toolchains">extra_toolchains</a>, <a href="#zig_configure_test-host_mode">host_mode</a>, <a href="#zig_configure_test-host_threaded">host_threaded</a>,
                   <a href="#zig_configure_test-host_use_cc_common_link">host_use_cc_common_link</a>, <a href="#zig_configure_test-host_zigopt">host_zigopt</a>, <a href="#zig_configure_test-mode">mode</a>, <a href="#zig_configure_test-target">target</a>, <a href="#zig_configure_test-threaded">threaded</a>, <a href="#zig_configure_test-translate_c">translate_c</a>,
                   <a href="#zig_configure_test-use_cc_common_link">use_cc_common_link</a>, <a href="#zig_configure_test-zig_version">zig_version</a>, <a href="#zig_configure_test-zigopt">zigopt</a>)
</pre>
...
| <a id="zig_configure_test-translate_c"></a>translate_c |  If true, enables the external translate-c toolchain when one is registered.   | Integer | optional |  `-1`  |
